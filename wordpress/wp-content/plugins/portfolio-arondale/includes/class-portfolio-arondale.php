...
class Portfolio_Arondale {
     ...
     * @since    1.0.0
     * @access   protected
     * @var      Portfolio_Arondale_Loader    $loader    Maintains and registers all hooks for the plugin.
     */
    protected $loader;
    ...
    public function __construct() {
        ...
        $this->plugin_name = 'portfolio-arondale';
        $this->version = '1.0.0';
    ...
    private function load_dependencies() {
         ...
         * core plugin.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-portfolio-arondale-loader.php';

        /**
         * The class responsible for defining internationalization functionality
         * of the plugin.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-portfolio-arondale-i18n.php';
         ...
         * of the plugin.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-portfolio-arondale-setting.php';

        /**
         * The class responsible for defining all actions that occur in the admin area.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-portfolio-arondale-admin.php';

        /**
         * The class responsible for defining all actions that occur in the public-facing
         * side of the site.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-portfolio-arondale-public.php';

        $this->loader = new Portfolio_Arondale_Loader();
    ...
    private function set_locale() {
        ...
        $plugin_i18n = new Portfolio_Arondale_i18n();
    ...
    private function define_admin_hooks() {
        ...
        $plugin_admin = new Portfolio_Arondale_Admin( $this->get_plugin_name(), $this->get_version() );
    ...
    private function define_public_hooks() {
        ...
        $plugin_public = new Portfolio_Arondale_Public( $this->get_plugin_name(), $this->get_version() );

        $this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'enqueue_styles' );
        $this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'enqueue_scripts' );

        //Add  Short Code
        add_shortcode('portfolio-arondale', array($plugin_public, 'portfolio_shortcode_function' ));
     ...
     *
     * @since     1.0.0
     * @return    Portfolio_Arondale_Loader    Orchestrates the hooks of the plugin.
     */
