jQuery(document).ready(function($) {
  ...
  jQuery('#sbi_admin th label, #sbi_admin .sb_instagram_layout_setting label, #sbi_admin .sbi_shortcode_label').click(function(){
  ...
  jQuery('#sbi_admin th, #sbi_admin .sb_instagram_layout_setting label, #sbi_admin .sbi_shortcode_label').hover(function(){
